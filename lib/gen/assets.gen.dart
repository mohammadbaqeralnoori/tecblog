...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/bluevoice.png
  AssetGenImage get bluevoice =>
      const AssetGenImage('assets/icons/bluevoice.png');
  ...
  List<AssetGenImage> get values =>
      [bluepen, bluevoice, downCatArrow, hashtagicon, home, user, write];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<dynamic> get values => [logo, posterTest, profileavatar, techbot];
}
